...
def build_prompt(gender: str, category: str, makeup: bool = True) -> str:
    ...
    return (
        ...
        "If the border, pallu or body has figurative motifs - elephants, peacocks or "
        "other birds and animals, dancing figures, or other pictorial embroidery - "
        "reproduce those exact figures faithfully; never fall back to a generic "
        "floral or geometric border in their place just because they're intricate. "
        "Reproduce fine repeating textures (thin pinstripes, checks, leheriya "
        "tie-dye bands, dotted or sequinned patterns) at their true density and "
        "spacing, not smoothed into a few broad bands of colour. Keep the exact "
        "colour and shade, without shifting the hue or washing it out or "
        "oversaturating it. Let the pattern follow the fabric's folds, pleats and "
        ...
        "Image 2 may show the garment several times (angles, a collage, a mirror), worn "
        "by a model, or displayed on a mannequin or hanger - sometimes held or propped "
        "into shape with a hand, wooden dowel or clip (e.g. a headless mannequin with a "
        "peg for an arm, or a hand holding up a dupatta or pallu so it drapes nicely for "
        "the photo). None of that is the garment. Image 2 is a reference for the "
        "garment's design only: do not carry over any part of a model, mannequin, prop, "
        "hand, dowel or clip from Image 2 into the result, even a fragment of one - the "
        "person in the result has only their own arms, hands and body from Image 1. "
        "Image 2 may also be a screenshot with watermarks, logos, price tags or app "
        "buttons. Treat it as one garment, use the clearest view, and never draw any "
        "watermark or text onto the result.\n"
